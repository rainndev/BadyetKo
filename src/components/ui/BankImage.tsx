...
const BankImage = ({ custom_bank_avatar }: { custom_bank_avatar: string }) => {
  ...
  return isLoading ? (
    ...
    <div className="bg-dark-background/10 border-dark-background/5 flex min-h-10 w-full min-w-10 shrink-0 items-center justify-center rounded-xl border md:min-h-12 md:min-w-12">
