const ChartPieDonutPlaceholder = () => {
  return [...new Array(5)].map((_, idx) => (
    <div
      ...
      className="bg-dark-background/50 flex w-fit animate-pulse items-center gap-2 rounded-full p-2 px-4 text-[clamp(.5rem,1vw+.5rem,.85rem)] leading-none font-medium"
    >
